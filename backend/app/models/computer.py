...
class Computer(Base):
    ...
    agent_state = Column(String(30), nullable=True)
    agent_version = Column(String(50), nullable=True)
    agent_started_at = Column(DateTime, nullable=True)
    agent_last_attempt_at = Column(DateTime, nullable=True)
    agent_last_success_at = Column(DateTime, nullable=True)
    agent_last_error_at = Column(DateTime, nullable=True)
    agent_last_error_message = Column(String(500), nullable=True)
    agent_consecutive_failures = Column(Integer, nullable=True)
    agent_offline_queue_size = Column(Integer, nullable=True)
    collected_at = Column(DateTime, nullable=True)
    sync_attempt = Column(Integer, nullable=True)
